...
/// @nodoc
abstract class _$$PostByDateRequestImplCopyWith<$Res>
    implements $PostByDateRequestCopyWith<$Res> {
  factory _$$PostByDateRequestImplCopyWith(_$PostByDateRequestImpl value,
          $Res Function(_$PostByDateRequestImpl) then) =
      __$$PostByDateRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String date,
...
/// @nodoc
class __$$PostByDateRequestImplCopyWithImpl<$Res>
    extends _$PostByDateRequestCopyWithImpl<$Res, _$PostByDateRequestImpl>
    implements _$$PostByDateRequestImplCopyWith<$Res> {
  __$$PostByDateRequestImplCopyWithImpl(_$PostByDateRequestImpl _value,
      $Res Function(_$PostByDateRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PostByDateRequestImpl(
      date: null == date
          ? _value.date
          : date // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$PostByDateRequestImpl
  ...
  factory _$PostByDateRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$PostByDateRequestImplFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PostByDateRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PostByDateRequestImplCopyWith<_$PostByDateRequestImpl> get copyWith =>
      __$$PostByDateRequestImplCopyWithImpl<_$PostByDateRequestImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PostByDateRequestImplToJson(
      this,
    );
  }
}
...
abstract class _PostByDateRequest implements PostByDateRequest {
  factory _PostByDateRequest(
      ...
      @JsonKey(name: "is_fresh_data_required")
      final bool isFreshDataRequired}) = _$PostByDateRequestImpl;

  factory _PostByDateRequest.fromJson(Map<String, dynamic> json) =
      _$PostByDateRequestImpl.fromJson;
